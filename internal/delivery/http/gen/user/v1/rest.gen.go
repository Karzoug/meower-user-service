...
type PutUsersUserIDdefaultJSONResponse struct {
	Body       ErrorResponse
	StatusCode int
}

func (response PutUsersUserIDdefaultJSONResponse) VisitPutUsersUserIDResponse(w http.ResponseWriter) error {
...
// PutUsersUserID operation middleware
func (sh *strictHandler) PutUsersUserID(w http.ResponseWriter, r *http.Request, userID string) {
	...
	if err != nil {
		...
		if err := validResponse.VisitPutUsersUserIDResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
